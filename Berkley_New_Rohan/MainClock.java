...
public class MainClock {
    public static void main(String args[]){
        ...
        LocalTime newServerTime = serverTime.plusNanos(avg);

        c1.adjustTime(newServerTime);
        c2.adjustTime(newServerTime);
        c3.adjustTime(newServerTime);
        serverTime.plusNanos(avg);

        System.out.println("updated time"+newServerTime);
        } catch (Exception ex) {
